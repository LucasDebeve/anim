...
INSERT INTO "new_Offer" ("age_max", "age_min", "beginAt", "city", "contractId", "country", "createdAt", "description", "endAt", "id", "interAccepted", "offerTypeId", "organizationId", "postal_code", "remuneration", "title", "userId") SELECT "age_max", "age_min", "beginAt", "city", "contractId", "country", "createdAt", "description", "endAt", "id", "interAccepted", "offerTypeId", "organizationId", "postal_code", "remuneration", "title", "userId" FROM "Offer";
DROP TABLE "Offer";
